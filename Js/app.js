...
class calorieTracker{
    ...
    //FUNCTION TO DISPLAY TOTAL CALORIES
    ...
    _displayCaloriesLimit(){
        const _totalCaloriesL = document.getElementById('calories-limit');
        _totalCaloriesL.innerHTML = this._calorieLimit
    }

    // FUNCTION TO DISPLAY CALORIES CONSUMED
    ...
    // FUNCTION TO DISPLAY CALORIES BURNED
     ...
     //FUNCTION TO DISPLAY REMAINING CALORIES
...
class App {
    ...
    _newitem(type,e){
        ...
        name.value = '';
        calories.value = '';
        const closeitem = document.getElementById(`collapse-${type}`)
        const bsCollapse = new bootstrap.Collapse(closeitem ,{
            toggle : true
        })
    }
